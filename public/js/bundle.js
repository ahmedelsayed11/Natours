...
exports.loginUser = exports.logOut = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', _context.t0 === null || _context.t0 === void 0 || (_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message);
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Log out failed, Try again later!');
        case 10:
        case "end":
...
function _initMap() {
  _initMap = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var map, locations, _yield$google$maps$im, Map, _yield$google$maps$im2, AdvancedMarkerElement, bounds, marker, positions;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          ...
          bounds = new google.maps.LatLngBounds(); // The map, centered at first element
          map = new Map(document.getElementById('map'), {
            zoom: 12,
            mapId: '6e97189f64439a21'
          });
          locations.forEach(function (item) {
            positions = new google.maps.LatLng(item.coordinates[1], item.coordinates[0]);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your data has been updated successfully!');
          }
          window.setTimeout(function () {
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currentPassword, newPassword, confirmPassword) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your password has been updated successfully!');
          }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NyxVcKxtA5zRsd9bxunc9QMycJrMe6Cp7v6VoAIjBNL7chEfvceXZTFfdbjOv5YYB7LBEPZ3zUI4ENwPSyGI17J000fLWrvYL');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://localhost:9000/api/v1/booking/checkout-session/".concat(tourId)
          });
        case 3:
          response = _context.sent;
          console.log('🚀 ~ file: stripe.js:15 ~ bookTour ~ response:', response.data.session);
          _context.next = 7;
...
var mapInThePage = document.getElementById('map');
if (mapInThePage) {
  window.initMap = _mapbox.initMap;
}
...
if (userPasswordForm) {
  document.querySelector('.form-user-settings').addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.updatePassword)(currentPassword, newPassword, confirmPassword);
          case 7:
...
var bookTourElement = document.querySelector('.book-tour');
if (bookTourElement) {
  bookTourElement.addEventListener('click', function (e) {
